# run_tb3b_gazebo_empty_world.sh
#!/bin/bash
...
echo " \-->> mount volumes with the following tag:"
echo " --volume="${PWD}/tb3_autonomy":"/overlay_ws/src/tb3_autonomy":rw "
...
# Run the command
docker run -it --net=host --ipc=host $DOCKER_ARGS nvnoetic bash
